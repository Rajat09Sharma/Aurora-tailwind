...
export const Price = () => {
    return (
        <>
            <div id="Pricing" className='py-16 px-5 text-center scroll-m-14 md:mt-14 md:mx-16 md:scroll-mt-28'>
                <h2 className='text-2xl font-bold md:text-4xl'>Simple, transparent pricing</h2>
                <p className='mt-2.5 text-gray-600 dark:text-gray-400'>Pick a card to practice hover, focus, and ring utilities.</p>
                <div className='flex flex-col justify-center space-y-8  mt-10 text-left md:flex-row md:justify-between md:space-y-0 md:gap-14'>
                    ...
                    <PricePack title={"Pro"} price={"$19"} contnent={["Unlimited projects", "Priority support", "Advanced analytics"]} active={" border-indigo-300 bg-indigo-50/50 dark:bg-slate-800"} />
