...
export const Features = () => {
    return (
        <div id="Features" className="flex flex-col justify-center py-16 scroll-m-19 md:scroll-mt-28 md:mt-14 md:mx-16 md:flex-row md:justify-between">
            ...
            <div className="widget-container right py-5 px-3 mx-5 mt-8 bg-white border border-gray-300 rounded-xl space-y-3 shadow-lg shadow-gray-400 md:w-3/7 md:items-center md:mt-0 dark:bg-slate-800 dark:border-gray-500">
                <Wideget />
                <Wideget />
                <Wideget />
            </div>
